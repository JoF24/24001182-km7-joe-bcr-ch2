        ...
        <div class="card" style="width: 20vw;">
            <div class="card-body">
                ...
                <div class="d-flex mt-2">
                    <img src="/public/gambar/fi_users.png" alt="" style="width: 1.5vw; margin-right: 1vw;">
                    <p class="card-text">${car.capacity} Orang</p>
                </div>
                <div class="d-flex mt-2">
                    <img src="/public/gambar/fi_settings.png" alt="" style="width: 1.5vw; margin-right: 1vw;">
                    <p class="card-text">${car.transmission}</p>
                </div>
                <div class="d-flex mt-2">
                    <img src="/public/gambar/fi_calendar.png" alt="" style="width: 1.5vw; margin-right: 1vw;">
